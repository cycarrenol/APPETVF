package file.create.ejemplo.com.appet.dispositivosbt;
...
import file.create.ejemplo.com.appet.userinterfaz.UserInterfaz;
import file.create.ejemplo.com.appet.MainActivity;

public class DispositivosBT extends AppCompatActivity {


    private Button BatrasMainActivity;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        BatrasMainActivity = findViewById(R.id.BatrasMainActivity);

        BatrasMainActivity.setOnClickListener(new View.OnClickListener() {
            @Override
